...
//===================================================
let weSwiper = new Swiper('.we__swiper', {
	observer: true,
	observeParents: true,
	//slidesPerView: 1,
	//spaceBetween: 0,
...
//========================================================================
//let controlsOurWorksNavigation = document.querySelectorAll('.controls-our-works__navigation');


function initOurWorksSlider() {
	const sliderBlocks = document.querySelectorAll('.our-works__block');
	if (sliderBlocks.length > 0) {
		sliderBlocks.forEach((sliderBlock, index) => {
			sliderBlock.classList.add('_show');
			const slider = sliderBlock.querySelector('.our-works__slider');
			const ourWorksNavigation = sliderBlock.querySelector('.controls-our-works__navigation');
			const allNextOurWorksSlide = document.querySelectorAll('.controls-our-works__navigation')[index].querySelector('.controls-our-works__next');
			const allPrevOurWorksSlide = document.querySelectorAll('.controls-our-works__navigation')[index].querySelector('.controls-our-works__prev');
			//const allOurWorksSlidersProgress = document.querySelectorAll('.controls-our-works__item')[index].querySelector('.controls-our-works__progress');
			//const allOurWorksSlidersCounter = slider.querySelectorAll('.our-works__slide').length;
			const sliderItem = new Swiper(slider, {
				...
				/*
								pagination: {
									el: allOurWorksSlidersProgress,
									type: 'progressbar',
								},
				*/
				navigation: {
					nextEl: allNextOurWorksSlide,
					prevEl: allPrevOurWorksSlide,
				},
				...
				on: {
					...
					/*
										init: function () {
											allNextOurWorksSlide.innerHTML = setZeroFormat(allOurWorksSlidersCounter);
										},
										init: function () {
					
											allPrevOurWorksSlide.innerHTML = setZeroFormat(allOurWorksSlidersCounter);
										},
										*/
				}
				/*
				on: {
					...
					init: function () {
						allNextOurWorksSliders.innerHTML = setZeroFormat(allOurWorksSlidersCounter);
					},
					slideChange: function (sl) {
						let currentSlide = ++sl.realIndex;
						allPrevOurWorksSlide.innerHTML = setZeroFormat(currentSlide);
					},
	...
	if (sliderBlocks.length > 0) {
		sliderBlocks.forEach((sliderBlock, index) => {
			sliderBlock.classList.add('_show');
			const ourWorksSliderB = sliderBlock.querySelector('.our-works__slider-b');

			const allNextOurWorksSlide = document.querySelectorAll('.controls-our-works__navigation')[index].querySelector('.controls-our-works__next');
			const allPrevOurWorksSlide = document.querySelectorAll('.controls-our-works__navigation')[index].querySelector('.controls-our-works__prev');

			const sliderItemB = new Swiper(ourWorksSliderB, {
				observer: true,
				observeParents: true,
				slidesPerView: 5,
				spaceBetween: 0,
	...
	if (sliderBlocks.length > 0) {
		sliderBlocks.forEach((sliderBlock, index) => {
			sliderBlock.classList.add('_show');
			const ourWorksSliderC = sliderBlock.querySelector('.our-works__slider-c');

			const allNextOurWorksSlide = document.querySelectorAll('.controls-our-works__navigation')[index].querySelector('.controls-our-works__next');
			const allPrevOurWorksSlide = document.querySelectorAll('.controls-our-works__navigation')[index].querySelector('.controls-our-works__prev');

			const sliderItemC = new Swiper(ourWorksSliderC, {
				observer: true,
				observeParents: true,
				slidesPerView: 5,
				spaceBetween: 0,
...
const tabsOurWorks = document.querySelector('.tabs-our-works');
tabsOurWorks.addEventListener("click", function (e) {
	const targetElement = e.target;
	if (targetElement.classList.contains('tabs-our-works__item')) {
		const tabsElements = Array.from(document.querySelectorAll('.tabs-our-works__item'));
		...
		const ourWorksNavigation = document.querySelectorAll('.controls-our-works__navigation');
		ourWorksNavigation.forEach(item => item.classList.remove('_active'));

		const ourWorksSliders = document.querySelectorAll('.our-works__block');
		ourWorksSliders.forEach(item => item.classList.remove('_active'));

		ourWorksNavigation[index].classList.add('_active');
		ourWorksSliders[index].classList.add('_active');
	}
...
function initOurFacilitiesSlider() {
	...
	if (sliderBlocks.length > 0) {
		sliderBlocks.forEach((sliderBlock, index) => {
			...
			const allNextOurFacilitiesSlide = document.querySelectorAll('.our-facilities__navigation')[index].querySelector('.our-facilities__next_righ');
			const allPrevOurFacilitiesSlide = document.querySelectorAll('.our-facilities__navigation')[index].querySelector('.our-facilities__next_left');
			...
			const sliderItem = new Swiper(slider, {
				...
				navigation: {
					nextEl: allNextOurFacilitiesSlide,
					prevEl: allPrevOurFacilitiesSlide,
				},
				loop: true,
				pagination: {
...
tabsOurFacilities.addEventListener("click", function (e) {
	...
	if (targetElement.classList.contains('tabs-our-facilities__item')) {
		...
		const ourFacilitiesNavigation = document.querySelectorAll('.our-facilities__navigation');
		ourFacilitiesNavigation.forEach(item => item.classList.remove('_active'));
		...
		ourFacilitiesNavigation[index].classList.add('_active');
...
//==================================
let userSlider = document.querySelector('.user__slider');
if (userSlider) {


	new Swiper(userSlider, {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
...
let var1 = document.querySelector('.help__more');
let var2 = document.querySelector('.help__more');

var1.addEventListener("click", someClick);

function someClick() {
	var2.classList.toggle('_active');
}
...
let hearts = document.querySelectorAll(".block-body__liks");
for (let heart of hearts) {
	heart.onclick = function (e) {
		this.classList.toggle("_active");
		this.classList.contains("_active") ? e.target.nextElementSibling.textContent++ : e.target.nextElementSibling.textContent--;
	}
}

//===========================================================
const textarea = document.querySelector('.form__textarea');
const valueSpan = document.querySelector('.form__value span');

textarea.addEventListener("keydown", function (e) {
	valueSpan.innerHTML = textarea.value.length;
});

//=====================================================
const dItems = document.querySelectorAll('.investor__item');
if (dItems.length > 0) {
...
let contentButton = document.querySelector('.form-content__button');
let contentAttention = document.querySelector('.form-content__attention');

contentButton.addEventListener("click", someClick);

function someClick() {
	contentButton.classList.toggle('_active');
	contentAttention.classList.toggle('_active');
				...
				*/
				/*
							...
							const calendarItem = datepicker(input, {
								...
								onSelect: function (input, instanse, date) {
									input_focus_add(input.el);
								}
							});
			*/
				...
				const calendarItem = datepicker(input, {
					customDays: ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"],
					customMonths: ["Янв", "Фев", "Мар", "Апр", "Мaй", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек"],
					overlayButton: 'Применить',
					overlayPlaceholder: 'Год (4 цифры)',
					startDay: 1,
					formatter: (input, date, instance) => {
...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(41.7166315, 44.8762586)],
